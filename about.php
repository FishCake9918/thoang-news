      ...
      <div class="col-lg-5 col-xl-4">
        <div class="sidebar">
          ...
          <div class="sidebar-block">
            ...
            <div class="quick-fact"><i class="bi bi-bookmark"></i><span><a href="saved.php" style="color:var(--navy);text-decoration:none">Tin đã lưu của bạn</a></span></div>
            <div class="quick-fact"><i class="bi bi-newspaper"></i><span><a href="article.php" style="color:var(--navy);text-decoration:none">Đọc bài viết đầy đủ</a></span></div>
          </div>
        </div>
      </div>
